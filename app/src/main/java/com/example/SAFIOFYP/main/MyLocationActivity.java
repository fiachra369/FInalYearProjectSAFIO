                                ...
                                if (recordDay.equals(currentDay)) {
                                    ...
                                    if (recordHour == currentHour) {
                                        ...
                                        if (location_Address.contains("O'Connell Street Lower")) {
                                            ...
                                            width = 10;
                                            Log.d("GRAFTON STREET", "===============================================" + record.getGraftonStreet());
                                            Log.d("GRAFTON STREET", "===============================================" + record.getDateTime());
...
//                                        Log.d("HOUR NOT", "===============================================NOT MATCHETD");
                                    }
                                } else {
//                                    Log.d("DAY NOT", "===============================================NOT MATCHETD");
                                }
                            } else {
//                                Log.d("MONTH NOT", "===============================================NOT MATCHETD");
                            }
                        } else {
//                            Log.d("YEAR NOT", "===============================================NOT MATCHETD");
                        }
                    }
                        ...
                        public void onResponse(Call<StreetBody> call, Response<StreetBody> response) {
                            ...
                            if (response.isSuccessful()) {
                                ...
                                for (Street street : response.body().getResult().getStreets()) {
                                    Log.d("LENGTH: ", "==============================================" + street.getStreetName());

                                    Log.d("LENGTH: ", "==============================================" + response.body().getResult().getStreets().size());
                                                ...
                                                if (street.getStreetName().toLowerCase().equals("parnell street")) {
                                                    ...
                                                    if (street.getStreetName().toLowerCase().equals("capel street")) {
                                                        ...
                                                        if (street.getStreetName().toLowerCase().equals(streetName.toLowerCase())) {
                                                            length = street.getLineLength();
                                                            Log.d("STREET NAME : ", "==============================================" + street.getStreetName());
                                                            break;
                                                        }
                                ...
                                Log.d("STREET NAME VAR: ", "==============================================" + streetName);
                                ...
                                Log.d("AREA IS : ", "==============================================" + area);
                                Log.d("AVERAGE PEOPLE IS : ", "==============================================" + average);
                                Log.d("STREET RISK IS : ", "==============================================" + streetRisk);
                                Log.d("USER RISK IS : ", "==============================================" + Constants.USER_RISK_SCORE);
                                Log.d("FINAL RISK SCORE IS : ", "==============================================" + finalRisk);
//                                if (average >= thresh)
//                                {
//                                    safeStreet.setText("NOT SAFE");
//                                }
